...
//$input=$r4['tc'];
	...
	if(trim($error)=="")
	{
        ...
        //echo "<textarea id='div' class=\"form-control\" name=\"output\" rows=\"10\" cols=\"50\">$output</textarea><br><br>";
				 echo "<div class=\"row\" style='text-align:center; color:green'><div class=\"col-sm-5\"></div><div class=\"col-sm-5\"><div class=\"alert alert-success\"><strong>Compilation Successful!</strong></div></div><div class=\"col-sm-2\"></div></div><br>";
        }
